...
class VerticalProfile(Encoder):
    ...
    def from_polytope(self, result):
        ...
        self.func(result, lat, long, coords, mars_metadata, param, range_dict, step, levels, dates)
    ...
    def func(self, tree, lat, long, coords, mars_metadata, param, range_dict, step, levels, dates):
        if len(tree.children) != 0:
        # recurse while we are not a leaf
            for c in tree.children:
                if c.axis.name != "latitude" and c.axis.name != "longitude" and c.axis.name != "param" and c.axis.name != "step" and c.axis.name != "date" and c.axis.name != "levelist":
                ...
                self.func(c, lat, long, coords, mars_metadata, param, range_dict, step, levels, dates)
        else:
